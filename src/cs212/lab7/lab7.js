...
function handleSubmit(event) {
  ...
  const madLibResult = `In a ${adjective} land, there were ${pluralNoun} ${color} ${animal}s ${verb} ${adverb}, with ${bodyPart} of ${occupation} enjoying eating ${food} feeling ${emotion}!`;
